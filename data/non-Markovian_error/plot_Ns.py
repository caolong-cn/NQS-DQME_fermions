...
data_files = ["T_0.06_m3_Nb1_Ns2", "T_0.06_m3_Nb1_Ns4"]
Ns = ["2", "4"]
...
for ax in [axs[0]]:
    ax.set_ylabel(r"$\chi_m$ ($1/\Gamma$)", fontsize=19)

# Adjust layout to prevent overlap
plt.tight_layout()

# Save and show the plot
plt.savefig("chi_evolution_vs_Ns_m3.png", dpi=300)
plt.savefig("chi_evolution_vs_Ns_m3.pdf")
